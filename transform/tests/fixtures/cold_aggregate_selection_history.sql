...
WITH scenarios AS (
    ...
    UNION ALL SELECT 'cold_today', 1, 60.0, 'Heat', 60.0, 5.0, 0.0, 0.0, 0.0, 60.0, 'available', TRUE, 1.0, 30.0, 3.0, 4.0, 1.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'cold_tomorrow', 0, 70.0, 'Rain', 0.0, 10.0, 0.0, 70.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, 2.0, 4.0, 2.0, 6, 6, 1.0, TRUE
    ...
    UNION ALL SELECT 'earlier_tie', 1, 80.0, 'Cold', 0.0, 80.0, 0.0, 10.0, 0.0, 0.0, 'available', TRUE, 1.0, 11.0, -11.0, 5.0, 16.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'heat_tie', 0, 70.0, 'Heat', 70.0, 70.0, 70.0, 70.0, 70.0, 70.0, 'available', TRUE, 1.0, 34.0, -10.0, 4.0, 14.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'heat_tie', 1, 65.0, 'Cold', 0.0, 65.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -9.0, 4.0, 13.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'unmonitored_cold', 0, 30.0, 'Cold', 0.0, 30.0, 10.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -2.0, 4.0, 6.0, 6, 6, 1.0, TRUE
    ...
    UNION ALL SELECT 'partial_cold', 1, 20.0, 'Cold', 0.0, 20.0, 10.0, 10.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, 0.0, 4.0, 4.0, 6, 6, 1.0, TRUE
    ...
    UNION ALL SELECT 'missing_cold', 1, 20.0, 'Cold', 0.0, 20.0, 10.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, 0.0, 4.0, 4.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'air_tie', 0, 35.0, 'Air Quality', 0.0, 35.0, 0.0, 0.0, 35.0, 0.0, 'available', TRUE, 1.0, 10.0, -3.0, 4.0, 7.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'air_tie', 1, 30.0, 'Cold', 0.0, 30.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -2.0, 4.0, 6.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'outside_window', -1, 100.0, 'Cold', 0.0, 100.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -20.0, 4.0, 24.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'outside_window', 0, 10.0, 'Rain', 0.0, 10.0, 0.0, 10.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, 2.0, 4.0, 2.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'outside_window', 1, 30.0, 'Cold', 0.0, 30.0, 0.0, 20.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -2.0, 4.0, 6.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'outside_window', 2, 100.0, 'Heat', 100.0, 100.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 40.0, -20.0, 4.0, 24.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'zero_beats_unavailable', 0, CAST(NULL AS FLOAT64), 'Unavailable', CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), 'unavailable', TRUE, 0.0, CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), 4.0, CAST(NULL AS FLOAT64), 6, 0, 0.0, FALSE
    ...
    UNION ALL SELECT 'both_unavailable', 1, CAST(NULL AS FLOAT64), 'Unavailable', CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), CAST(NULL AS FLOAT64), 'unavailable', TRUE, 0.5, 10.0, 0.0, 4.0, CAST(NULL AS FLOAT64), 6, 0, 0.083, TRUE
    UNION ALL SELECT 'outside_only', -1, 100.0, 'Cold', 0.0, 100.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 10.0, -20.0, 4.0, 24.0, 6, 6, 1.0, TRUE
    UNION ALL SELECT 'outside_only', 2, 100.0, 'Heat', 100.0, 100.0, 0.0, 0.0, 0.0, 0.0, 'available', TRUE, 1.0, 40.0, -20.0, 4.0, 24.0, 6, 6, 1.0, TRUE
)
